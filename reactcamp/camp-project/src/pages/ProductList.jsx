...
export default function ProductList() {
    ...
    const dispatch = useDispatch() // function çağırmak için dispatch kullanılır
    ...
    /* yukarıdaki şekilde yazılabildiği gibi fonksiyon şeklinde de yazılabilir
                ...
                <Table.Body>
                    {products.map((product) => (
                        <Table.Row key={product.id}>
                            <Table.Cell>
                                <Link to={`/products/${product.productName}`}>{product.productName}
                                </Link>
                            </Table.Cell>
